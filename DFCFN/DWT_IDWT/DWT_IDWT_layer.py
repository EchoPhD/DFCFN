...
class DWT_2D(Module):
    ...
    def forward(self, inputs):
        ...
        self.input_height = inputs.size()[-2]
        self.input_width = inputs.size()[-1]
        self.get_matrix()
        return DWTFunction_2D.apply(inputs, self.matrix_low_0, self.matrix_low_1, self.matrix_high_0, self.matrix_high_1)
